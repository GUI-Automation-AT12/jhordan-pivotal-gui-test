...
public class ProfilePage extends BaseLoggedInPage {
    ...
    @FindBy(xpath =   "//li[@id='general_error']//h4")
    private WebElement wrongMessageUserName;
    ...
    /**
     * Find the type of data from the Profile Page as String.
     * @return User name as String
     */
    public String getActualInformation(String type) {
        String element = "";
        switch (type) {
            case "Username":
                element = getProfileUserNameAsString();
                break;
            case "Name":
                element = getProfileNameAsString();
                break;
            case "Initials":
                element = getProfileInitialsAsString();
                break;
    ...
    public String getTextFromErrorMessage() {
        return GuiInteractioner.getTextFromWebElement(wrongMessageUserName);
    }
    /**
